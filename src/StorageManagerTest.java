...
public class StorageManagerTest {
    ...
    public static void testNonIntPK(StorageManager storageManager, Catalog catalog) {
        ...
        Record record0 = new Record(recTuple0, Integer.BYTES + 20, 2);
        ...
        Record record1 = new Record(recTuple1, Integer.BYTES + 20, 2);
        ...
        Record record2 = new Record(recTuple2, Double.BYTES + 20, 2);
        ...
        Record record3 = new Record(recTuple3, Double.BYTES + 20, 2);
        ...
        Record record4 = new Record(recTuple4, 1 + string4.length(), 2);
        ...
        Record record5 = new Record(recTuple5, 1 + string5.length(), 2);
        ...
        Record record6 = new Record(recTuple6, 1 + string6.length(), 2);
        ...
        Record record7 = new Record(recTuple7, 1 + string7.length(), 2);
    ...
    public static void testInsert(Catalog catalog, StorageManager storageManager) {
        ...
        Record record = new Record(recTuple, Integer.BYTES + 20 + 1, 3);
        Record record2 = new Record(recTuple2, Integer.BYTES + 20 + 1, 3);
